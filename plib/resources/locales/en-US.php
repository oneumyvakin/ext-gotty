...
$messages = [
    'useDomainsCertificate' => 'Use domain SSL/TLS certificate instead of self-signed. Warning: make sure that there no domains that using default certificate of Plesk panel!',
